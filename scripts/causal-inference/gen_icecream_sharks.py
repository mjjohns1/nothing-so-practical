...
OUT = (
    ...
    / "static/img/posts/causal-inference/icecream-sharks.svg"
)
...
def main():
    ...
    ax2 = ax1.twinx()
    l2, = ax2.plot(x, SHARKS, color=RED, linewidth=2.2,
                   linestyle=":", marker="s", markersize=4,
                   alpha=0.82, label="Shark attacks")
    ...
    ax1.set_title("Ice Cream Sales vs. Shark Attacks Over Time",
