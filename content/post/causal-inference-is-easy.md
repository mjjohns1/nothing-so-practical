...
[^3]: The do-operator is not an intuitive concept. Explaining it in detail is beyond the scope of this post. For a more detailed explanation see the post [do-Calculus for Humans](/post/do-the-do-calc/).