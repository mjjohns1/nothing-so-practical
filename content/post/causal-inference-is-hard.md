...
In the HRT example, we specified health consciousness as the main confound. How do you measure that? The Nurses’ Health Study tried. Researchers collected data on diet, exercise, smoking status, alcohol use, preventive care visits, and vitamin consumption. The treated and untreated groups still weren’t comparable. Health consciousness isn’t a checklist of behaviors, it’s a disposition that leads someone to ask her doctor about hormone therapy in the first place. The observational studies captured the visible markers of health consciousness but missed the trait that drove both HRT use and cardiovascular health. Controlling for the markers didn’t eliminate the confounding, leaving residual bias in the estimates.

Many variables that matter for causal inference are abstract constructs. Motivation, risk tolerance, management quality, organizational culture. Causal inference frameworks require that you've measured all the confounders, not just some of them. If health consciousness has three dimensions and you only capture two, the unmeasured dimension still confounds your result. Those carefully matched samples are not comparable in the ways that matter.
